...
var myApp = angular
	.module('myApp',['ngRoute', 'ngResource', 'ui.bootstrap', 'ngSanitize', 
		...
		'ui.tree', 'ui.grid','ui.grid.edit', 'ui.grid.resizeColumns','ui.grid.pinning', 'isteven-multi-select', 'xeditable','blockUI','daterangepicker','ui.bootstrap.carousel','ui.grid.moveColumns'])
